...
## 2. Tech Stack
- **LLM**: Gemma 3 (1B parameters, default for speed) and Dolphin-Phi (2.7B parameters, for deeper thinking)
...
### A. Modes
- **Default Mode**: Uses Gemma 3 (1B parameters) for fast, instant responses.
- **Deep Think Mode**: Switches to Dolphin-Phi when prompted (e.g., "think about it") for more detailed, thoughtful replies.
